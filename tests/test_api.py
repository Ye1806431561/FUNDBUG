...
def test_get_watchlist(client, mock_crud):
...
def test_add_to_watchlist_existing(client, mock_crud):
...
def test_add_to_watchlist_new(client, mock_crud, mock_data):
    fl, ho = mock_data
...
def test_remove_from_watchlist(client, mock_crud):
...
def test_get_fund_info(client, mock_crud):
...
def test_get_estimate(client, mock_engine):
    me, ec = mock_engine
